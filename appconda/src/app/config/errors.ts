...
export default {
    ...
    [Exception.HEALTH_INVALID_HOST]: {
        ...
        description: 'Failed to establish a connection to the specified domain. Please verify the        specified domain. Please verify the domain name and ensure that the server is running and accessible.',
        code: 404,
    },
