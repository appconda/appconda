...
App.post('/v1/users')
    ...
    .param('password', '', (project: Document, passwordsDictionary: any) => new PasswordDictionary(passwordsDictionary, project.getAttribute('auths', []).passwordDictionary ?? false), 'Plain text user password. Must be at least 8 chars.', true, ['project', 'passwordsDictionary'])
