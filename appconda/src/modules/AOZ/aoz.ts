...
AOZ.prototype.getObject = function( name )
{
	var aObject;
	if ( typeof name == 'string' )
	{
		aObject = this.root.objects[ name.toLowerCase() ];
		if ( !aObject )
...
AOZ.prototype.updateObject = function( aozObject, varsModified, fromFriend )
{
...
AOZ.prototype.updateFriends = function( aozObject, friends, deltaTime, vars, varsModified )
{
	for ( var f = 0; f < friends.length; f++ )
	{
		...
		if ( aozObject.fromFriend != thisObject )
		{
