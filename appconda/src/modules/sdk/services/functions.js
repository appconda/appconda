...
class Functions extends Service {
    ...
    async create(functionId, name, runtime, execute, events, schedule, timeout, enabled, logging, entrypoint, commands, installationId, providerRepositoryId, providerBranch, providerSilentMode, providerRootDirectory, templateRepository, templateOwner, templateRootDirectory, templateBranch) {
        ...
        if (typeof functionId === 'undefined') {
            throw new RealmoceanException('Missing required parameter: "functionId"');
        }
        ...
        if (typeof runtime === 'undefined') {
            throw new RealmoceanException('Missing required parameter: "runtime"');
        }
    ...
    async createDeployment(functionId, code, activate, entrypoint, commands, onProgress = () => {}) {
        ...
        if (typeof code === 'undefined') {
            throw new RealmoceanException('Missing required parameter: "code"');
        }

        if (typeof activate === 'undefined') {
            throw new RealmoceanException('Missing required parameter: "activate"');
        }
    ...
    async getDeployment(functionId, deploymentId) {
        ...
        if (typeof deploymentId === 'undefined') {
            throw new RealmoceanException('Missing required parameter: "deploymentId"');
        }
    ...
    async createBuild(functionId, deploymentId, buildId) {
        ...
        if (typeof buildId === 'undefined') {
            throw new RealmoceanException('Missing required parameter: "buildId"');
        }
    ...
    async getExecution(functionId, executionId) {
        ...
        if (typeof executionId === 'undefined') {
            throw new RealmoceanException('Missing required parameter: "executionId"');
        }
    ...
    async createVariable(functionId, key, value) {
        ...
        if (typeof value === 'undefined') {
            throw new RealmoceanException('Missing required parameter: "value"');
        }
    ...
    async getVariable(functionId, variableId) {
        ...
        if (typeof variableId === 'undefined') {
            throw new RealmoceanException('Missing required parameter: "variableId"');
        }
