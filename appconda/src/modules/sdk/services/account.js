...
class Account extends Service {
    ...
    async updatePhone(phone, password) {
        ...
        if (typeof phone === 'undefined') {
            throw new RealmoceanException('Missing required parameter: "phone"');
        }
    ...
    async createRecovery(email, url) {
        ...
        if (typeof url === 'undefined') {
            throw new RealmoceanException('Missing required parameter: "url"');
        }
    ...
    async updateRecovery(userId, secret, password, passwordAgain) {
        ...
        if (typeof passwordAgain === 'undefined') {
            throw new RealmoceanException('Missing required parameter: "passwordAgain"');
        }
