export class OcelEventFeatures {
	...
	static encodeStrAttrEv(ocel, strAttributes: any = null) {
	...
	static encodeNumAttrEv(ocel, numAttributes: any = null) {
