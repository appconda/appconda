...
export class IntervalTree{
    ...
    static Node: typeof IntervalTreeNode;
...
class IntervalTreeNode{
    ...
    static IntervalComparator: (a: any, b: any) => number;
...
export class SortedArray extends Array{
    ...
    comparator: (a: any, b: any) => 1 | -1 | 0;
    reversedComparator: any;
    // Construct a new SortedArray. Uses Array.sort to sort
    // the input collection, if any; the sort may be unstable.
    constructor(...args: any[]){
        let values: any = null;
        let valuesEqual: any = null;
        let comparator: any = null;
        let reversedComparator: any = null;
    ...
    slice(){
        const slice: any = Array.prototype.slice.apply(this, arguments as any);
    ...
    splice(...args:any[]){
        const splice: any = Array.prototype.splice.apply(this, arguments as any);
    ...
    concat(){
        ...
        const array = Array.prototype.concat.apply(this, arguments as any);
    ...
    flat(){
        this.constructor = Array;
        const array = Array.prototype.flat.apply(this, arguments as any);
        this.constructor = SortedArray;
        return array;
    }
    ...
    flatMap(){
        this.constructor = Array;
        const array = Array.prototype.flatMap.apply(this, arguments as any);
        this.constructor = SortedArray;
        return array;
    }
    ...
    map(){
        this.constructor = Array;
        const array = Array.prototype.map.apply(this, arguments as any);
        this.constructor = SortedArray;
        return array;
    }
}
