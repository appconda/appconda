...
export class Hook {
    ...
    param(key: string, defaultValue: any, validator: Validator | (() => boolean), description: string = '', optional: boolean = false, injections: any[] = [], skipValidation: boolean = false): this {
        this.params[key] = {
