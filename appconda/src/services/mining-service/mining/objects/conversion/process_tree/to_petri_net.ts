...
import { ProcessTreeOperator } from "../../process_tree/process_tree";

export class ProcessTreeToPetriNetConverter {
	static apply(processTree) {
		let nodes: any = ProcessTreeToPetriNetConverter.orderBottomUpNodes(processTree);
