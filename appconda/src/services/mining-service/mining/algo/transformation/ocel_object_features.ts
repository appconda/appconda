import { IntervalTreeAlgorithms } from "./interval_tree";
import { OcelGraphs } from "./ocel_graphs";
import { OcelIntervalTree } from "./ocel_interval_tree";

export class OcelObjectFeatures {
	...
	static filterOnIndexes(fea, idxs) {
		let filteredFea: any = {"featureNames": [], "data": []};
		let j = 0;
		while (j < idxs.length) {
	...
	static encodeObjStrAttr(ocel, strAttributes: any=null) {
	...
	static encodeObjNumAttr(ocel, numAttributes: any=null) {
