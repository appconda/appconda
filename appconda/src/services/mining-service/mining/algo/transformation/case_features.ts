...
import { FrequencyDfgDiscovery } from "../discovery/dfg/algorithm";
import { IntervalTreeAlgorithms, IntervalTreeBuilder } from "./interval_tree";
import { OcelObjectFeatures } from "./ocel_object_features";

export class CaseFeaturesOutput {
	data: any;
	features: any;
...
export class CaseFeatures {
	static INCLUDE_WIP: any;
	static INCLUDE_RESOURCE_WORKLOAD: any;
	static apply(eventLog, activityKey = "concept:name", caseIdKey = "concept:name", evStrAttr: any = null, evNumAttr: any = null, trStrAttr: any = null, trNumAttr: any = null, evSuccStrAttr: any = null, timestampKey = "time:timestamp", resourceKey = "org:resource", includeWorkInProgress = CaseFeatures.INCLUDE_WIP, includeResourceWorkload = CaseFeatures.INCLUDE_RESOURCE_WORKLOAD) {
		let vect: any = null;
	...
	static automaticFeatureSelection(eventLog, activityKey = "concept:name", caseIdKey = "concept:name") {
		...
		let evStrAttrCandidatesWithValues: any = {};
		let evNumAttr: any = [];
		let trStrAttrCandidatesWithValues: any = {};
		let trNumAttr: any = [];
