...
import { is } from '../is';
import { cBottom, cHorizontal, cLeft, CornerRadiusTypes, cRight, cTop, cVertical, FontWeightModifierTypes, IFont, 
    PositionTypes, ShadowTypes, TextAligns, TextTransforms } from './UIView/Constants';
import { AppearanceObject } from './UIView/AppearanceObject';
import { ColorClass } from './UIView/ColorClass';
import { StyleAttribute } from './UIView/StyleAttribute';
...
export class AppearanceClass {
    ...
    public padding(...args: any[]): this {
        ...
        } else if (args.length === 2 && is.string(args[0]) && is.number(args[1])) {
            const type: string = args[0];
